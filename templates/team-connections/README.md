...
- Works on LinkedIn CSV exports alone. A built-in enrichment loop (Perplexity API or web-search subagents) keeps current titles current; network tools (VouchFor, a CRM) are optional add-ons.
