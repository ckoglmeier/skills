...
| investor-profile | Decision-ready intelligence on investors, funds, angels, and potential acquirers — thesis, portfolio, deal mechanics, key people, warm paths, and meeting prep | [SKILL.md](https://raw.githubusercontent.com/ckoglmeier/skills/main/templates/investor-profile/skills/investor-profile/SKILL.md) |
| person-profile | Pre-meeting intelligence on an individual — internal history, warm paths, career narrative, what they care about, public voice, network influence, and meeting hooks | [SKILL.md](https://raw.githubusercontent.com/ckoglmeier/skills/main/templates/person-profile/skills/person-profile/SKILL.md) |
| team-connections | "Who do we know at X?" across the whole team's LinkedIn exports — tiered warm paths, best connector, best sender | [SKILL.md](https://raw.githubusercontent.com/ckoglmeier/skills/main/templates/team-connections/skills/team-connections/SKILL.md) |
| venture-concept-discovery | Raw venture idea → GO / RESHAPE-THE-WEDGE / NO-GO with rubric, wedge, kill gates, and a 90-day plan | [SKILL.md](https://raw.githubusercontent.com/ckoglmeier/skills/main/templates/venture-discovery/skills/venture-concept-discovery/SKILL.md) |
| discovery-pass-designer | Designs a sectioned, multi-model research pass — cheap models retrieve, strong models judge; supports cross-provider handoff | [SKILL.md](https://raw.githubusercontent.com/ckoglmeier/skills/main/templates/venture-discovery/skills/discovery-pass-designer/SKILL.md) |
